...
namespace SCOOP.GUI
{
    public partial class Relatorios1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Selecione um tipo de Relatorio para depois Gerar!","",MessageBoxButtons.OKCancel,MessageBoxIcon.Exclamation);
            }
        }
        ...
        public void showCrystalReport()
        {
            ...
            if (Relatorios == "Medição")
            {
                report = this.Medicao1;                
                SetParameterFieldInfo("NumeroFolha", TxtBoxValor.Text, "NumeroFinalFolha", FolhaFinalTxtBox.Text);
                report.SetDatabaseLogon("scoop", "scoop", @"PMC0091SRVSIPA1", "scoop");
                crystalReportViewer1.ReportSource = report;
               
            }
            else if (Relatorios == "Contrato")
            {
            ...
            else if (Relatorios == "Solicitacao")
            {
            ...
            else if (Relatorios == "Orçamento")
            {
                report = this.Orcamento1;
                SetParameterFieldInfo("NumeroOrcamento", TxtBoxValor.Text, "NumeroFinalOrcamento", FolhaFinalTxtBox.Text);
                report.SetDatabaseLogon("scoop", "scoop", @"PMC0091SRVSIPA1", "scoop");
                crystalReportViewer1.ReportSource = report;
